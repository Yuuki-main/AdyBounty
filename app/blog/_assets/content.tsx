...
export const categories: categoryType[] = [
  {
    ...
    description:
      "Here are the latest features we've added to BOunty Game. I'm constantly improving our product to help you teach better.",
    // A short version of the description above, only displayed in the <Header /> on mobile. Up to 60 characters.
    descriptionShort: 'Latest features added to BOunty Game.',
  },
  {
    ...
    description:
      "Learn how to use BOunty Game with these step-by-step tutorials. I'll show you how to teach better and save time.",
    descriptionShort:
      'Learn how to use BOunty Game with these step-by-step tutorials.',
  },
]
